...
import { Shield, ArrowRight, TrendingUp, Users } from 'lucide-react';
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col text-white overflow-hidden">
      ...
      <div className="relative z-20 w-full flex-grow flex flex-col justify-center items-center px-4 pt-24 pb-12 sm:pt-32 sm:pb-16">
          ...
          {/* Stats Section */}
          <motion.div 
            className="w-full max-w-4xl mx-auto mt-16 sm:mt-24"
                ...
                {stats.map((stat, index) => (
                    ...
                    >
                        <div className='flex justify-center items-center gap-4'>
                            <stat.icon className="h-7 w-7 sm:h-8 sm:w-8 text-blue-400 transition-colors duration-300 group-hover:text-blue-300" />
                            <p className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent">{stat.value}</p>
                        </div>
